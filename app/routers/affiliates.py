...
def get_optional_user_id(request: Request) -> Optional[int]:
    ...
    try:
        ...
        # sub usually contains the username; ensure your token logic matches this
        # If your 'sub' is username, you might need a query here. 
        # Assuming sub is the user_id string for this helper:
        user_id_raw = payload.get("sub")
        return int(user_id_raw) if user_id_raw and user_id_raw.isdigit() else None
    except Exception:
        return None
